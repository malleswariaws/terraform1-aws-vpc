...
### Public Route table ###
resource "aws_route_table" "public" { # first name is public[0], second name is public[1]
  vpc_id = aws_vpc.main.id
...
### Private Route table ###
resource "aws_route_table" "private" { # first name is public[0], second name is public[1]
  vpc_id = aws_vpc.main.id
...
resource "aws_route_table" "database" { # first name is public[0], second name is public[1]
  vpc_id = aws_vpc.main.id
